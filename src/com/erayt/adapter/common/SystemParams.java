...
public class SystemParams {
	...
	/**
	 * 
	 * 字段类型:5=表示该字段数据格式为ahs;bas;cmd,此数据对应的map的value需要转换为一个list<String,Map>
	 */
	public static final int PROPERTIES_FIELDTYPE_TOLIST = 5;
	 ...
	 * 推送转发平台价格的title
	 */
	public static final String XFWDING_SPOT="XFWDING.FeedPrice.SPOT";
	public static final String XFWDING_SWAP="XFWDING.FeedPrice.SWAP";
	public static final String XFWDING_BONDS="XFWDING.FeedPrice.BONDS";
	public static final String XFWDING_IR="XFWDING.FeedPrice.IR";
